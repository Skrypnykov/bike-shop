...
function Form() {
    ...
    return (
        <BorderContainer>
            ...
            {selectedTab === 0 && (
                <Flex padding="60px 80px" direction="column">
                    ...
                    <form onSubmit={onSubmitFormData}>
                        ...
                        <TextField
                            placeholder="Телефон"
                            errorLabel="Пожалуйста, введите номер вашего телефона."
            ...
            {selectedTab === 1 && (
                <Flex padding="60px 80px" direction="column">
                    <Text margin="30px 0 100px" font-size="18px">Введите номер заказа, что бы узнать о его статусе:</Text>
                    <form action="" onSubmit={onSubmitDelivery}>
                        ...
                        <p>
                            {({
                                200: "Ваш заказ ожидает отправки",
